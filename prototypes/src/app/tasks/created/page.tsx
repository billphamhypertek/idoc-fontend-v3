...
import { TaskItem, tasksCreated } from "@/data/tasks-data";
...
const tabs = [
    ...
    { id: "in-progress", label: "Đang thực hiện", count: 1 },
];
...
export default function TasksCreatedPage() {
    ...
    const [data] = useState<TaskItem[]>(tasksCreated);
    ...
    return (
        <PageLayout activeModule="tasks" activeSubMenu="created">
            <div className="space-y-4">
                {/* Page Header */}
                <h1 className="text-xl font-semibold text-[hsl(var(--v3-card-foreground))]">Nhiệm vụ đã giao</h1>
