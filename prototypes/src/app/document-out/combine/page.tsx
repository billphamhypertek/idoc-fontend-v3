...
import { documentOutCombine } from "@/data/document-out-data";
...
const tabs = [
    ...
    { id: "processing", label: "Đang phối hợp", count: 0 },
];

export default function DocumentOutCombinePage() {
    const router = useRouter();
    const [activeTab, setActiveTab] = useState("pending");
    const [selectedIds, setSelectedIds] = useState<string[]>([]);
    const [data, setData] = useState<DocumentItem[]>(documentOutCombine);
    ...
    return (
        <PageLayout activeModule="doc-out" activeSubMenu="combine">
