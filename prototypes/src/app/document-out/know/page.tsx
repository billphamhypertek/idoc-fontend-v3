...
import { documentOutKnow } from "@/data/document-out-data";
...
export default function DocumentOutKnowPage() {
    ...
    const [data, setData] = useState<DocumentItem[]>(documentOutKnow);

    const filteredData = data.filter((item) => {
        if (activeTab === "unread") return item.status === "done";
    ...
    return (
        <PageLayout activeModule="doc-out" activeSubMenu="know">
