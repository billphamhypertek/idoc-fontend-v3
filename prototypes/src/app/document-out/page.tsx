...
import { documentOutList } from "@/data/document-out-data";
...
const tabs = [
    ...
    { id: "done", label: "Đã hoàn thành", count: 2 },
];

export default function DocumentOutListPage() {
    const router = useRouter();
    const [activeTab, setActiveTab] = useState("pending");
    const [selectedIds, setSelectedIds] = useState<string[]>([]);
    const [data, setData] = useState<DocumentItem[]>(documentOutList);
