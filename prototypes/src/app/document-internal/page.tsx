...
import { documentInternalList } from "@/data/document-internal-data";
...
const tabs = [
    ...
    { id: "done", label: "Đã xử lý", count: 1 },
];

export default function DocumentInternalListPage() {
    const router = useRouter();
    const [activeTab, setActiveTab] = useState("pending");
    const [selectedIds, setSelectedIds] = useState<string[]>([]);
    const [data, setData] = useState<DocumentItem[]>(documentInternalList);
    ...
    return (
        <PageLayout activeModule="doc-internal" activeSubMenu="doc-internal">
            <div className="space-y-4">
                {/* Header */}
                <h1 className="text-xl font-semibold text-[hsl(var(--v3-card-foreground))]">Danh sách văn bản</h1>
