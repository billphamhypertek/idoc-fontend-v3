...
import { reportsQuarterly, ReportItem } from "@/data/reports-data";
...
export default function ReportsQuarterlyPage() {
    const [data] = useState<ReportItem[]>(reportsQuarterly);

    return (
        <PageLayout activeModule="reports" activeSubMenu="quarterly">
            <div className="space-y-4">
                {/* Page Header */}
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold text-[hsl(var(--v3-card-foreground))]">Báo cáo quý</h1>
