...
import { reportsGov, ReportItem } from "@/data/reports-data";
import { PlusIcon, FileTextIcon } from "@radix-ui/react-icons";
import { CheckCircle2, Clock, XCircle, FileEdit, Printer, Upload } from "lucide-react";
...
export default function ReportsGovPage() {
    const [data] = useState<ReportItem[]>(reportsGov);

    return (
        <PageLayout activeModule="reports" activeSubMenu="gov">
            <div className="space-y-4">
                {/* Page Header */}
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold text-[hsl(var(--v3-card-foreground))]">Báo cáo Chính phủ</h1>
                    <div className="flex items-center gap-2">
                        <button className="inline-flex items-center gap-2 h-9 px-4 rounded-lg bg-orange-600 text-white text-sm font-medium hover:bg-orange-700 transition-colors shadow-sm">
