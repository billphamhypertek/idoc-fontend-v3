...
import { reportsWeekly, ReportItem } from "@/data/reports-data";
...
export default function ReportsWeeklyPage() {
    const [data] = useState<ReportItem[]>(reportsWeekly);

    return (
        <PageLayout activeModule="reports" activeSubMenu="weekly">
            <div className="space-y-4">
                {/* Page Header */}
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold text-[hsl(var(--v3-card-foreground))]">Báo cáo tuần</h1>
