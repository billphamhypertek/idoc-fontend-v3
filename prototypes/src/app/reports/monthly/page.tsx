...
import { reportsMonthly, ReportItem } from "@/data/reports-data";
...
export default function ReportsMonthlyPage() {
    const [data] = useState<ReportItem[]>(reportsMonthly);

    return (
        <PageLayout activeModule="reports" activeSubMenu="monthly">
            <div className="space-y-4">
                {/* Page Header */}
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold text-[hsl(var(--v3-card-foreground))]">Báo cáo tháng</h1>
