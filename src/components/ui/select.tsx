  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      `flex h-9 w-full items-center justify-between whitespace-nowrap
       ...
       ring-offset-background focus:outline-none focus:ring-2 focus:ring-blue-400
       disabled:cursor-not-allowed disabled:opacity-50 disabled:bg-[#e9ecef]
       /* truncate cho text */
       [&_span]:truncate [&_span]:overflow-hidden [&_span]:text-ellipsis [&_span]:whitespace-nowrap [&_span]:min-w-0`,
      className
    )}
    {...props}
  >
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 w-full rounded-md border bg-popover text-popover-foreground shadow-md",
        "overflow-hidden", // quan trọng: để chứa scrollbar bên trong
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1 w-full",
          // Đây là dòng quan trọng nhất: bật lại scrollbar!
      ...
      {/* Tùy chọn: thêm style global để chắc chắn hơn */}
      <style jsx global>{`
