...
import { cancelTokenSource, publicAxiosInstance } from "~/api/axiosInstances";
...
export const publicGetWitCancelToken = (
  url: string,
  cancelToken: any,
  params?: any
) =>
...
export const publicPost = (url: string, body?: any) =>
  publicAxiosInstance.post(url, body);
...
export const publicPut = (url: string, params?: any) =>
  publicAxiosInstance.put(url, params).then((res) => res.data);
